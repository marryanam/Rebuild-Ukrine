...
function rebuild_scripts() {
	...
	wp_enqueue_style( 'main-style', get_template_directory_uri(). '/css/main.css?v.380.6', array(), _S_VERSION );
    ...
    wp_enqueue_script( 'main-script', get_template_directory_uri() . '/js/main.js?v.77.4', array(), _S_VERSION, true );
