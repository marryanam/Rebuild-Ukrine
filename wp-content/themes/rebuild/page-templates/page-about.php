...
<main class="page-wrapper about_page">
    ...
    <section class="section_2 scroll-y col_section">
        <div class="container">
            <div class="column">
    ...
    <section class="section_3 scroll-y tickerLine">
        <div class="ticker">
    ...
    <section class="section_4 scroll-y half-circle-list">
        <div class="container">
            <div class="column">
    ...
    <section class="section_7 scroll-y">
        <div class="container">
